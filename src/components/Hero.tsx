    ...
    <main className="relative min-h-screen flex items-center justify-center hero-gradient">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        <div className="text-center">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-[#F7931A] mb-8 tracking-tight">
          ...
          <a
            ...
            className="inline-block bg-[#F7931A] text-black font-semibold px-8 py-4 rounded-full hover:transform hover:-translate-y-1 transition-all duration-200 shadow-lg hover:shadow-[#F7931A]/20"
          >
